...
import { DispatcharrFields, type DispatcharrForm } from './DispatcharrFields';
...
export interface AddServerDialogProps {
  ...
  onServerTypeChange: (type: 'plex' | 'jellyfin' | 'emby' | 'dispatcharr') => void;
  dispatcharr?: DispatcharrForm;
      ...
      <DialogContent className={SERVER_DIALOG_CONTENT_CLASS}>
        ...
        <FieldGroup className="py-4">
          <Field className="max-w-sm">
            ...
            <Select
              value={serverType}
              onValueChange={(v) => onServerTypeChange(v as AddServerDialogProps['serverType'])}
            >
          ...
          {serverType === 'plex' ? (
            ...
            <>
              ...
              {serverType === 'dispatcharr' ? (
                dispatcharr &&
                onDispatcharrChange && (
                  <DispatcharrFields value={dispatcharr} onChange={onDispatcharrChange} />
                )
              ) : (
                <Field>
